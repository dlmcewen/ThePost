...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"><c:out value = "${currentSessionUser.fName}" /> <c:out value = "${currentSessionUser.lName}" />'s Dashboard</h1>
			<div id="result">
    			<c:choose>
    				<c:when test="${requestScope['message'] == 'Removed item from database'}">
			            <div class="alert alert-success">
			              <strong>You have successfully removed the listing!</strong>
			            </div>
			        </c:when>
			        <c:when test="${requestScope['message'] == 'Updated object in database'}">
			            <div class="alert alert-success">
			              <strong>You have successfully updated the listing!</strong>
			            </div>
			        </c:when>
    			</c:choose>
   			 </div>
      ...
      <h2 class="sub-header">All Listed Items</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <c:forEach items="${listBean.allItems}" var="item"> 
